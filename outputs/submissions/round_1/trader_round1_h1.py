...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: h1
# Label   : Round-1 Phase-8.5 hybrid (promoted PEPPER + alt ASH)
# Purpose : Phase-8.5 narrow hybrid candidate. Promoted PEPPER leg (validated robust default) + alt ASH leg (best official ASH on the one Round-1 data point). Captures the empirically-justified ASH uplift without adopting alt PEPPER's higher-variance inventory bet.
# Factory : src.core.config.round1_h1_engine_config
# Built   : 2026-04-15T12:05:15.452821+00:00 (commit 51efc59)
# Embedded product configs:
#   ASH_COATED_OSMIUM: {'position_limit': 50, 'fair_value_method': 'wall_mid', 'fair_value_fallbacks': ('mid', 'microprice'), 'anchor_price': 10000.0, 'taker_edge': 0.5, 'maker_edge': 1.5, 'quote_size': 5, 'max_aggressive_size': 10, 'inventory_skew': 4.0, 'flatten_threshold': 0.7, 'history_length': 48}
#   INTARIAN_PEPPER_ROOT: {'position_limit': 50, 'fair_value_method': 'linear_drift', 'fair_value_fallbacks': ('depth_mid', 'hybrid_wall_micro', 'mid'), 'anchor_price': None, 'taker_edge': 2.0, 'maker_edge': 1.0, 'quote_size': 4, 'max_aggressive_size': 8, 'inventory_skew': 2.0, 'flatten_threshold': 0.7, 'history_length': 32}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_h1_engine_config()
