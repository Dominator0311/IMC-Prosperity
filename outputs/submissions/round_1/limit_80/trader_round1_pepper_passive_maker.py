...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: pepper_passive_maker
# Label   : Round-1 PEPPER passive-maker candidate
# Purpose : Breaks out of buy_and_hold on PEPPER. Posts inside-spread passive maker with asymmetric long bias (bid_edge=3, ask_edge=5) anchored to linear_drift forecast. Core target 40 leaves 40 units of cycling headroom. Local 3-day PEPPER mean +45,248.
# Factory : src.core.config.round1_pepper_passive_maker_engine_config
# Built   : 2026-04-16T19:43:30.290793+00:00 (commit dfcb239)
...
# PEPPER strategy: PepperPassiveMakerStrategy (research-only, inlined)
# PEPPER params: {'bid_edge': 3.0, 'ask_edge': 5.0, 'quote_size': 5, 'inventory_skew_coef': 0.04, 'core_target': 40, 'floor': 0, 'ceiling': 80, 'seed_mode': 'passive', 'seed_size': 40, 'seed_window': 500, 'seed_taker_fallback_after': 3, 'min_spread_for_maker': 4}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_pepper_passive_maker_engine_config()
...
_ASH_PEPPER_PASSIVE_MAKER_PARAMS = LadderParams(
    edges=(2.5, 4.0, 6.0),
...
def _ash_pepper_passive_maker_factory(fve: FairValueEngine, sig: SignalEngine) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_PEPPER_PASSIVE_MAKER_PARAMS)

_PEP_PEPPER_PASSIVE_MAKER_PARAMS = PassiveMakerParams(
    bid_edge=3.0,
    ask_edge=5.0,
    quote_size=5,
...
def _pep_pepper_passive_maker_factory(fve: FairValueEngine, sig: SignalEngine) -> BaseStrategy:
    return PepperPassiveMakerStrategy(fve, sig, _PEP_PEPPER_PASSIVE_MAKER_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder", "pepper_passive_maker"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(
        STRATEGY_REGISTRY,
        **{
            "ash_ladder": _ash_pepper_passive_maker_factory,
            "pepper_passive_maker": _pep_pepper_passive_maker_factory,
        }
    )
)
