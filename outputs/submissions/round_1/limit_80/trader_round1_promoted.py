...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: promoted
# Label   : Round-1 promoted / robust default
# Purpose : Phase-5 promoted candidates. C-ASH-A (ewma_mid, t=0.25) + C-PEP-A (linear_drift h=32, t=2.0, flatten=0.7). Designed for cross-day robustness and minimal limit-pinning.
# Factory : src.core.config.round1_promoted_engine_config
# Built   : 2026-04-15T17:10:19.656692+00:00 (commit 7bc6241)
# Embedded product configs:
#   ASH_COATED_OSMIUM: {'position_limit': 80, 'fair_value_method': 'ewma_mid', 'fair_value_fallbacks': ('mid', 'microprice'), 'anchor_price': 10000.0, 'taker_edge': 0.25, 'maker_edge': 1.0, 'quote_size': 5, 'max_aggressive_size': 10, 'inventory_skew': 4.0, 'flatten_threshold': 0.7, 'history_length': 48, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_promoted_engine_config()
