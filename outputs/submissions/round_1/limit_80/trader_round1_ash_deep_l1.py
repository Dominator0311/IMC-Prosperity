...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_l1
# Label   : Round-1 Phase-L L1 — tighter outer (2.5/3.5/5)
# Purpose : Tighter than K2 (2.5/3.5/5 vs K2's 2.5/4/6). Tests whether the OU amplitude distribution peak is even closer to fair than K2 assumes. Local collapsed to 5 maker (edges too close, sim treats all levels similarly to F3a) but official fill model is different; worth the one upload.
# Factory : src.core.config.round1_ash_deep_l1_engine_config
# Built   : 2026-04-16T18:46:00.805053+00:00 (commit bb8570c)
...
# ASH params: {'edges': (2.5, 3.5, 5.0), 'size_mults': (1.0, 1.5, 2.0), 'skew_coef': 2.0, 'flatten_threshold': 0.7, 'weights': (3, 1, 1)}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_l1_engine_config()
...
_ASH_DEEP_L1_PARAMS = LadderParams(
    edges=(2.5, 3.5, 5.0),
...
def _ash_deep_l1_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_DEEP_L1_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_ladder=_ash_deep_l1_ash_strategy_factory)
)
