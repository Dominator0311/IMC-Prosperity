...
# Purpose : V3_nearhold PEPPER (near-buy-and-hold + sparse overlay) + wall_mid ASH. base_long=80 with opening seed=65/window=500. Matches buy_hold_80 carry on the proxy (+7351 vs +7279) with overlay optionality preserved for reversing days.
# Factory : src.core.config.round1_v3_nearhold_engine_config
# Built   : 2026-04-15T22:01:18.254887+00:00 (commit 043faac)
...
#   {'base_long': 80, 'add_thresh': 3.0, 'trim_thresh': 8.0, 'add_gain': 5.0, 'trim_gain': 2.0, 'floor': 40, 'ceiling': 80, 'step': 8, 'exec_style': 'taker', 'hybrid_threshold': 2.0, 'maker_edge_offset': 0.0, 'open_seed_size': 65, 'open_window': 500, 'open_no_short': True}
# ========================================================================
