...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_g1
# Label   : Round-1 Phase-G G1 — wall_mid + m=2.5 + linear skew c=2
# Purpose : Phase-G extension. Applies the F3a winning tuning (m=2.5/t=0.5 + linear skew c=2) on wall_mid FV instead of weighted_mid. Tests whether F3a's win comes from the FV choice or from the edge/skew tuning. Projected official +1 407 (vs F3a observed +1 395).
# Factory : src.core.config.round1_ash_deep_g1_engine_config
# Built   : 2026-04-16T15:30:06.284990+00:00 (commit 043faac)
# Embedded product configs:
#   ASH_COATED_OSMIUM: {'position_limit': 80, 'strategy_name': 'ash_shape_override', 'fair_value_method': 'wall_mid', 'fair_value_fallbacks': ('mid', 'microprice'), 'anchor_price': 10000.0, 'taker_edge': 0.5, 'maker_edge': 2.5, 'quote_size': 5, 'max_aggressive_size': 10, 'inventory_skew': 4.0, 'flatten_threshold': 0.7, 'history_length': 48, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
...
# ASH params: {'skew_mode': 'linear', 'skew_coef': 2.0, 'flatten_mode': 'hard', 'flatten_threshold': 0.7, 'size_mode': 'constant'}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_g1_engine_config()
...
_ASH_DEEP_G1_PARAMS = ShapeParams(
    skew_mode='linear',
    skew_coef=2.0,
    flatten_mode='hard',
    flatten_threshold=0.7,
...
def _ash_deep_g1_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshShapeOverrideStrategy(fve, sig, _ASH_DEEP_G1_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_shape_override"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_shape_override=_ash_deep_g1_ash_strategy_factory)
)
