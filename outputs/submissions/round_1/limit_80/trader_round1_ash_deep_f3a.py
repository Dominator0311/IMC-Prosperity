...
# Label   : Round-1 Phase-F F3a — D5 empirical stack (weighted_mid + m=2.5 + linear skew c=2)
# Purpose : Phase-D D5 empirical stack — highest local PnL on record (+3 446/day on 3-day CV) AND one of the three stress-tape-robust candidates (zero losses on all six Phase-E ASH stress tapes). Uses the research-only AshShapeOverrideStrategy, inlined at bundle tail.
# Factory : src.core.config.round1_ash_deep_f3a_engine_config
# Built   : 2026-04-16T12:44:28.576839+00:00 (commit 043faac)
...
# ASH strategy: AshShapeOverrideStrategy (research-only, inlined at bundle tail; NOT part of the shipped STRATEGY_REGISTRY)
# ASH ShapeParams:
#   {'skew_mode': 'linear', 'skew_coef': 2.0, 'flatten_mode': 'hard', 'flatten_threshold': 0.7, 'size_mode': 'constant'}
# ========================================================================
