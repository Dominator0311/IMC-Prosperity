...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: baseline
# Label   : Round-1 baseline / control
# Purpose : Reference point. Phase-3 minimum-viable Round-1 default. Every other variant should beat this on official PnL.
# Factory : src.core.config.round1_baseline_engine_config
# Built   : 2026-04-15T17:10:19.541423+00:00 (commit 7bc6241)
# Embedded product configs:
#   ASH_COATED_OSMIUM: {'position_limit': 80, 'fair_value_method': 'wall_mid', 'fair_value_fallbacks': ('mid', 'microprice'), 'anchor_price': 10000.0, 'taker_edge': 1.0, 'maker_edge': 1.0, 'quote_size': 5, 'max_aggressive_size': 10, 'inventory_skew': 4.0, 'flatten_threshold': 0.7, 'history_length': 48, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
#   INTARIAN_PEPPER_ROOT: {'position_limit': 80, 'fair_value_method': 'linear_drift', 'fair_value_fallbacks': ('depth_mid', 'hybrid_wall_micro', 'mid'), 'anchor_price': None, 'taker_edge': 1.0, 'maker_edge': 1.5, 'quote_size': 4, 'max_aggressive_size': 8, 'inventory_skew': 2.0, 'flatten_threshold': 0.8, 'history_length': 48, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_baseline_engine_config()
