...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: alt
# Label   : Round-1 higher-upside alternate
# Purpose : Phase-5 higher-upside candidates. C-ASH-B (wall_mid, t=0.5) + C-PEP-B (linear_drift h=32, skew=1.0, flatten=0.9). Larger PnL ceiling at the cost of more taker / inventory exposure.
# Factory : src.core.config.round1_alt_engine_config
# Built   : 2026-04-15T17:10:19.774493+00:00 (commit 7bc6241)
...
#   INTARIAN_PEPPER_ROOT: {'position_limit': 80, 'fair_value_method': 'linear_drift', 'fair_value_fallbacks': ('depth_mid', 'hybrid_wall_micro', 'mid'), 'anchor_price': None, 'taker_edge': 2.0, 'maker_edge': 1.0, 'quote_size': 4, 'max_aggressive_size': 8, 'inventory_skew': 1.0, 'flatten_threshold': 0.9, 'history_length': 32, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_alt_engine_config()
