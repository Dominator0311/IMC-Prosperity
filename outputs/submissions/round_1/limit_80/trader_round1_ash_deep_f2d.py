...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_f2d
# Label   : Round-1 Phase-F F2d — wall_mid ASH m=2.5 + buy_hold PEPPER
# Purpose : ASH deep-dive upload F2d. ASH uses wall_mid at wider maker edge m=2.5 (Phase-B B2 edge-width winner) with taker edge t=0.5 and shipped skew=4.0 / flatten=0.7. PEPPER pinned at buy-and-hold with max_aggressive_size=80. Tests whether the Phase-B fill-mix improvement (18 maker fills vs 6 on shipped) transfers to official.
# Factory : src.core.config.round1_ash_deep_f2d_engine_config
# Built   : 2026-04-16T12:44:28.484872+00:00 (commit 043faac)
# Embedded product configs:
#   ASH_COATED_OSMIUM: {'position_limit': 80, 'strategy_name': 'market_making', 'fair_value_method': 'wall_mid', 'fair_value_fallbacks': ('mid', 'microprice'), 'anchor_price': 10000.0, 'taker_edge': 0.5, 'maker_edge': 2.5, 'quote_size': 5, 'max_aggressive_size': 10, 'inventory_skew': 4.0, 'flatten_threshold': 0.7, 'history_length': 48, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_f2d_engine_config()
