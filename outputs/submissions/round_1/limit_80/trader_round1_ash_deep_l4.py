...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_l4
# Label   : Round-1 Phase-L L4 — 4-level tight K2 extension
# Purpose : K2 plus a 4th outer level at d=8. Weights 3/1/1/1 = inner 50%, outers 16.7% each. Phase-K showed K3 with d=12 failed due to dilution; L4 keeps the 4th level at a more reachable depth (d=8). Local +3 535 — **best of Phase-L**, with 48 maker fills (vs K2's 26). Highest upside candidate.
# Factory : src.core.config.round1_ash_deep_l4_engine_config
# Built   : 2026-04-16T18:46:01.408912+00:00 (commit bb8570c)
...
# ASH params: {'edges': (2.5, 4.0, 6.0, 8.0), 'size_mults': (1.0, 1.5, 2.0, 3.0), 'skew_coef': 2.0, 'flatten_threshold': 0.7, 'weights': (3, 1, 1, 1)}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_l4_engine_config()
...
_ASH_DEEP_L4_PARAMS = LadderParams(
...
def _ash_deep_l4_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_DEEP_L4_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_ladder=_ash_deep_l4_ash_strategy_factory)
)
