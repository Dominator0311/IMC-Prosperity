...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_l5b
# Label   : Round-1 Phase-L L5b — K2 with mid outer sizes (1/2/4)
# Purpose : Between K2 (sizes 1/1.5/2) and L5 (sizes 1/3/5). Tests the middle-ground size-scaling hypothesis. Local identical to K2 (sim caps fill size) — official outcome should calibrate the right size-mult level.
# Factory : src.core.config.round1_ash_deep_l5b_engine_config
# Built   : 2026-04-16T18:46:01.908942+00:00 (commit bb8570c)
...
# ASH params: {'edges': (2.5, 4.0, 6.0), 'size_mults': (1.0, 2.0, 4.0), 'skew_coef': 2.0, 'flatten_threshold': 0.7, 'weights': (3, 1, 1)}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_l5b_engine_config()
...
_ASH_DEEP_L5B_PARAMS = LadderParams(
    edges=(2.5, 4.0, 6.0),
...
def _ash_deep_l5b_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_DEEP_L5B_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_ladder=_ash_deep_l5b_ash_strategy_factory)
)
