...
# Purpose : V2_clean PEPPER (opening-seeded core-long + overlay) + wall_mid ASH. Closes the first-25k PEPPER gap that every MM variant left unaddressed; ASH leg byte-identical to H1 / F5 / Alt.
# Factory : src.core.config.round1_v2_clean_engine_config
# Built   : 2026-04-15T20:39:01.855779+00:00 (commit 043faac)
# Embedded product configs:
#   ASH_COATED_OSMIUM: {'position_limit': 80, 'strategy_name': 'market_making', 'fair_value_method': 'wall_mid', 'fair_value_fallbacks': ('mid', 'microprice'), 'anchor_price': 10000.0, 'taker_edge': 0.5, 'maker_edge': 1.5, 'quote_size': 5, 'max_aggressive_size': 10, 'inventory_skew': 4.0, 'flatten_threshold': 0.7, 'history_length': 48, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
#   INTARIAN_PEPPER_ROOT: {'position_limit': 80, 'strategy_name': 'pepper_core_long', 'fair_value_method': 'linear_drift', 'fair_value_fallbacks': ('depth_mid', 'hybrid_wall_micro', 'mid'), 'anchor_price': None, 'taker_edge': 2.0, 'maker_edge': 1.0, 'quote_size': 10, 'max_aggressive_size': 20, 'inventory_skew': 2.0, 'flatten_threshold': 0.7, 'history_length': 32, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
# PEPPER strategy: PepperCoreLongStrategy (research-only, inlined at bundle tail; NOT part of the shipped STRATEGY_REGISTRY)
# PEPPER CoreLongParams:
#   {'base_long': 50, 'add_thresh': 3.0, 'trim_thresh': 5.0, 'add_gain': 5.0, 'trim_gain': 1.0, 'floor': 0, 'ceiling': 80, 'step': 8, 'exec_style': 'hybrid', 'hybrid_threshold': 2.0, 'maker_edge_offset': 0.0, 'open_seed_size': 60, 'open_window': 1000, 'open_no_short': True}
# ========================================================================
