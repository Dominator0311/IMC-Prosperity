...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_j2
# Label   : Round-1 Phase-J J2 — 3-level inner-heavy ladder (3/1/1)
# Purpose : Phase-J post-I2a test. I2a tied F3a officially (+1 365 vs +1 395) — edge per share +29% offset by volume −29%. J2 biases the tick-rotation toward the inner level (60%) to recover F3a's volume base while keeping outer-level coverage. Local +3 653 (vs I2a +3 666). Projected official ~+1 461 (Δ +66 vs F3a observed) if the inner-heavy design gets a better local-to-official transfer ratio than I2a.
# Factory : src.core.config.round1_ash_deep_j2_engine_config
# Built   : 2026-04-16T17:47:01.203568+00:00 (commit 043faac)
...
# ASH params: {'edges': (2.5, 5.0, 8.0), 'size_mults': (1.0, 1.5, 2.0), 'skew_coef': 2.0, 'flatten_threshold': 0.7, 'weights': (3, 1, 1)}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_j2_engine_config()
...
_ASH_DEEP_J2_PARAMS = LadderParams(
    edges=(2.5, 5.0, 8.0),
...
def _ash_deep_j2_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_DEEP_J2_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_ladder=_ash_deep_j2_ash_strategy_factory)
)