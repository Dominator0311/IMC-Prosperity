...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_l2
# Label   : Round-1 Phase-L L2 — split outer (2.5/4.5/7)
# Purpose : Middle ground between K2 (2.5/4/6) and J2 (2.5/5/8). Hypothesis: if the optimum is between K2 and J2 on the outer-edge axis, L2 wins. Local +3 482 (vs K2 +3 497).
# Factory : src.core.config.round1_ash_deep_l2_engine_config
# Built   : 2026-04-16T18:46:01.125820+00:00 (commit bb8570c)
...
# ASH params: {'edges': (2.5, 4.5, 7.0), 'size_mults': (1.0, 1.5, 2.0), 'skew_coef': 2.0, 'flatten_threshold': 0.7, 'weights': (3, 1, 1)}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_l2_engine_config()
...
_ASH_DEEP_L2_PARAMS = LadderParams(
    edges=(2.5, 4.5, 7.0),
...
def _ash_deep_l2_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_DEEP_L2_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_ladder=_ash_deep_l2_ash_strategy_factory)
)