...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_f3d
# Label   : Round-1 Phase-F F3d — AS gamma=5e-7
# Purpose : Phase-C C1 safer AS variant at gamma=5e-7 (middle of the 3-point Phase-C grid). Milder inventory-aware reservation-price shift than F2a (gamma=2e-6) — tests whether the less-aggressive AS tuning transfers better.
# Factory : src.core.config.round1_ash_deep_f3d_engine_config
# Built   : 2026-04-16T12:46:05.664665+00:00 (commit 043faac)
...
# ASH params: {'gamma': 5e-07, 'sigma': 2.0, 'k': 0.4, 'horizon': 100000, 'taker_edge': 0.5, 'min_half_spread': 0.5, 'flatten_threshold': 0.7}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_f3d_engine_config()
...
_ASH_DEEP_F3D_PARAMS = AvellanedaStoikovParams(
    gamma=5e-07,
    sigma=2.0,
    k=0.4,
    horizon=100000,
...
def _ash_deep_f3d_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshAvellanedaStoikovStrategy(fve, sig, _ASH_DEEP_F3D_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_avellaneda_stoikov"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_avellaneda_stoikov=_ash_deep_f3d_ash_strategy_factory)
)