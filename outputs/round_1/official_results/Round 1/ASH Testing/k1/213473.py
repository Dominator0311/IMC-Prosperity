...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_k1
# Label   : Round-1 Phase-K K1 — J2_heavier (67% inner)
# Purpose : J2 (weights 3/1/1, 60% inner) scored +1 647 officially — first variant to beat F3a (+1 395). J2's transfer ratio 0.451 was highest observed, suggesting inner-heavy variants UNDER-project locally. K1 pushes inner weight to 4/1/1 (67% inner, 16.5%/16.5% outer). Local +3 516 (vs J2 +3 653) but if transfer ratio rises further, could match or beat J2 officially.
# Factory : src.core.config.round1_ash_deep_k1_engine_config
# Built   : 2026-04-16T18:16:44.878833+00:00 (commit 16f3db7)
...
# ASH params: {'edges': (2.5, 5.0, 8.0), 'size_mults': (1.0, 1.5, 2.0), 'skew_coef': 2.0, 'flatten_threshold': 0.7, 'weights': (4, 1, 1)}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_k1_engine_config()
...
_ASH_DEEP_K1_PARAMS = LadderParams(
    edges=(2.5, 5.0, 8.0),
...
def _ash_deep_k1_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_DEEP_K1_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_ladder=_ash_deep_k1_ash_strategy_factory)
)