...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_f2b
# Label   : Round-1 Phase-F F2b — D6 m=2.5 + AS-continuous flatten
# Purpose : Phase-D D6: wall_mid at m=2.5/t=0.5 with AS-continuous flatten (skew_mode=as, gamma=5e-7) replacing the hard threshold. Best D-hybrid on expected-official at +2016; best wall_mid-family candidate on stress tapes.
# Factory : src.core.config.round1_ash_deep_f2b_engine_config
# Built   : 2026-04-16T12:46:05.786700+00:00 (commit 043faac)
...
# ASH params: {'skew_mode': 'as', 'as_gamma': 5e-07, 'as_sigma': 2.0, 'as_horizon': 100000, 'flatten_mode': 'as_continuous', 'size_mode': 'constant'}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_f2b_engine_config()
...
_ASH_DEEP_F2B_PARAMS = ShapeParams(
    skew_mode='as',
    as_gamma=5e-07,
    as_sigma=2.0,
    as_horizon=100000,
...
def _ash_deep_f2b_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshShapeOverrideStrategy(fve, sig, _ASH_DEEP_F2B_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_shape_override"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_shape_override=_ash_deep_f2b_ash_strategy_factory)
)