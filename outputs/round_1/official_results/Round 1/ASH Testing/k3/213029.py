...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_k3
# Label   : Round-1 Phase-K K3 — J2 plus d=12 outer (4-level)
# Purpose : J2 extension with a 4th outer level at d=12. Weights 3/1/1/1 → inner 50%, outers 16.7% each. Adds coverage for rare ±12-tick excursions while keeping J2's winning inner-heavy structure. Local +3 582 (vs J2 +3 653). Extreme-move fills are low probability but high edge when they land.
# Factory : src.core.config.round1_ash_deep_k3_engine_config
# Built   : 2026-04-16T18:16:45.337696+00:00 (commit 16f3db7)
...
# ASH params: {'edges': (2.5, 5.0, 8.0, 12.0), 'size_mults': (1.0, 1.5, 2.0, 3.0), 'skew_coef': 2.0, 'flatten_threshold': 0.7, 'weights': (3, 1, 1, 1)}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_k3_engine_config()
...
_ASH_DEEP_K3_PARAMS = LadderParams(
...
def _ash_deep_k3_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshLadderStrategy(fve, sig, _ASH_DEEP_K3_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_ladder"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_ladder=_ash_deep_k3_ash_strategy_factory)
)