...
# ========================================================================
# ROUND-1 UPLOAD VARIANT: ash_deep_f3e
# Label   : Round-1 Phase-F F3e — C3 Cartea beta=0.3
# Purpose : Phase-C C3 smallest-tested beta (0.3) at the Phase-C baseline m=2.0/t=0.5. Only C3 cell that landed above the shipped baseline on expected-official (+1107); lowest confidence of the Phase-F cohort and last priority in the upload order.
# Factory : src.core.config.round1_ash_deep_f3e_engine_config
# Built   : 2026-04-16T12:46:06.027093+00:00 (commit 043faac)
# Embedded product configs:
#   ASH_COATED_OSMIUM: {'position_limit': 80, 'strategy_name': 'ash_cartea_skew', 'fair_value_method': 'wall_mid', 'fair_value_fallbacks': ('mid', 'microprice'), 'anchor_price': 10000.0, 'taker_edge': 0.5, 'maker_edge': 2.0, 'quote_size': 5, 'max_aggressive_size': 10, 'inventory_skew': 4.0, 'flatten_threshold': 0.7, 'history_length': 48, 'taker_edge_buy': None, 'taker_edge_sell': None, 'early_window': 0, 'early_taker_edge_buy': None, 'early_taker_edge_sell': None, 'early_short_cap': None, 'early_short_skew_mult': 1.0, 'early_short_flatten': None}
...
# ASH params: {'beta': 0.3, 'fv_for_alpha': 'ewma_mid', 'sigma_residual_prior': 1.06, 'alpha_clip': 3.0, 'flatten_threshold': 0.7}
# ========================================================================
...
class Trader:
    def __init__(
        ...
        *,
        ...
        self.config = config or round1_ash_deep_f3e_engine_config()
...
_ASH_DEEP_F3E_PARAMS = CarteaSkewParams(
    beta=0.3,
...
def _ash_deep_f3e_ash_strategy_factory(
    fve: FairValueEngine, sig: SignalEngine
) -> BaseStrategy:
    return AshCarteaSkewStrategy(fve, sig, _ASH_DEEP_F3E_PARAMS)

KNOWN_STRATEGY_NAMES = tuple(
    sorted(set(KNOWN_STRATEGY_NAMES) | {"ash_cartea_skew"})
)
STRATEGY_REGISTRY = MappingProxyType(
    dict(STRATEGY_REGISTRY, ash_cartea_skew=_ash_deep_f3e_ash_strategy_factory)
)